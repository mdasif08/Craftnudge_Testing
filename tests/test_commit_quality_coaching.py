    ...
    def sample_analysis(self):
        ...
        return {
            ...
            "analysis_details": {
                ...
                "size_analysis": {"file_count": 3, "size_category": "small"},
            },
        }
...
class TestCoachingModels:
    ...
    def test_user_progress_creation(self):
        ...
        progress = UserProgress(
            ...
            quality_distribution={"EXCELLENT": 5, "GOOD": 12, "AVERAGE": 6, "POOR": 2},
    ...
    def test_coaching_response_creation(self):
        ...
        response = CoachingResponse(
            feedback=feedback, recommendations=["Focus on clear messages", "Keep commits small"]
        )

...
class FileSettings(BaseSettings):
    ...
    commits_file: str = Field(default="data/behaviors/commits.jsonl", description="Commits storage file")
...
class Settings(PydanticBaseSettings):
    ...
    class Config:
        ...
        fields = {
            'database__url': {'env': 'DATABASE_URL'},
            'redis__url': {'env': 'REDIS_URL'},
            'ollama__base_url': {'env': 'OLLAMA_BASE_URL'},
            'github__webhook_secret': {'env': 'GITHUB_WEBHOOK_SECRET'},
            'github__access_token': {'env': 'GITHUB_ACCESS_TOKEN'},
            'security__secret_key': {'env': 'SECRET_KEY'},
            'monitoring__sentry_dsn': {'env': 'SENTRY_DSN'},
        }
